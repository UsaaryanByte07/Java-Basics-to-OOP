...
public class Challenge_20 {
    ...
    public static void main(String[] args) {
        //20. Create a program to find the Least Common Multiple (LCM) of n numbers.(by Euclidean algorithm)
    ...
    public static void lcmOfArray(int[] arr){
        ...
        if (allZero) {
            System.out.println("LCM is undefined for all zero input.");
            return;
        }
        int lcm = Math.abs(arr[0]);
